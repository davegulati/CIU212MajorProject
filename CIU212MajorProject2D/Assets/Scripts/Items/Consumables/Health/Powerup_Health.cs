...
public class Powerup_Health : InteractableItem {
  ...
  //  {
    ...
    {
        sen.GetComponent<PlayerHealth>().PlayerReceiveHealth(healthAwarded);
		Notification.instance.Display("!", "ITEM OBTAINED", "Health", "Replenish some of Sen's health.", "Press 'I' to access your inventory.", notificationDuration);
		Destroy(gameObject);
    }
}
